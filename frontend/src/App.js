...
import { HomeOutlined, UserOutlined, BookOutlined, UsbOutlined, BulbOutlined, LinkOutlined, MoonOutlined, SunOutlined } from '@ant-design/icons';
...
const App = () => {
    ...
    const changeTheme = () => { document.body.classList.toggle('light-mode'); setLightMode(!lightMode); }; 
